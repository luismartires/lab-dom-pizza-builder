...
function renderPrice() {
  ...
  if (state.pepperoni) {
    ...
    ingredientsList.appendChild(pepperoniPrice);
    total += 1;
  }
  ...
  if (state.mushrooms) {
    ...
    ingredientsList.appendChild(mushroomPrice);
    total += 1;
  }
